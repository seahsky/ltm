...
N_EPISODES=""
TARGET="any"
# K-scaled step budget, 350/sub-goal (K=3): the 250-step single-goal default
# starves a K=3 mission (multion-micro: 0 sub-goals reached, best min_d2g
# 4.5 m at cap), and 750 truncated the idx2 leg in full2 (no episode reached
# a 3rd sub-goal -> the gap-by-index compounding curve had no idx2 point).
MAX_STEPS="1050"
