...
echo
echo "  READ SECTION C. Set eta so the MEDIAN of dream_segments_over_eta sits BELOW"
echo "  max_retained ($MAX_RETAINED). If it sits at or above the cap on most episodes,"
echo "  the CAP is the retention rule and eta is decoration — that is ADR-0024's top-k"
echo "  deviation, and it needs its own ADR rather than a quietly-raised cap."
echo
